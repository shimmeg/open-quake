...
- [Settings & knob lighting](docs/settings.md) · [Building & how it works](docs/building.md) · [Security hardening](docs/security/open-quake-hardening.md) · [Device protocol](docs/DEVICE_PROTOCOL.md)
