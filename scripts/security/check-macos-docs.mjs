...
assert.match(readme, /Node 24 LTS is the recommended baseline/, 'README must recommend Node 24 LTS as the primary baseline');
assert.match(readme, /Node 26 is\s+supported for local install, rebuild, and app packaging/, 'README must document Node 26 local tooling support');
...
assert.match(building, /Node 24 LTS is the recommended release baseline/, 'building docs must keep Node 24 as the release baseline');
assert.match(building, /Node 26 is\s+>?\s*supported for local install, rebuild, and unsigned packaging/, 'building docs must document Node 26 local build support');
